...
class SimpleTTSClient:
    def __init__(self):
        ...
        self.is_playing_audio = False  # New flag to track audio playback state
    ...
    async def _continuous_keep_alive(self):
        ...
        while self.is_connected:
            try:
                ...
                # if not self.is_playing_audio and self.websocket: REMOVED
                if self.websocket:
    ...
    async def send_text(self, text):
        ...
        try:
            ...
            # self.is_playing_audio = True REMOVED
